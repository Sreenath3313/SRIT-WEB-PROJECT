...
const Admissions: React.FC = () => {
    ...
    return (
        <section id="admissions" ref={ref} className="relative pt-4 pb-12 lg:pt-6 lg:pb-20 bg-orange-50 overflow-hidden">
            <div className="relative section-container max-w-[1100px] mx-auto z-10">
                {/* The "Card" Container */}
                <motion.div
                ...
                >
                    ...
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#FF5422]/20 rounded-[100%] blur-[90px] pointer-events-none animate-pulse" style={{ animationDuration: '4s' }} />
                    ...
                    <motion.div variants={itemVariants} className="relative z-10 inline-block mb-6">
                        <span className="px-5 py-2 rounded-full border border-[#FF5422]/30 bg-[#FF5422]/10 text-orange-400 text-[11px] md:text-sm font-bold tracking-[0.2em] uppercase backdrop-blur-sm shadow-[0_0_15px_rgba(255,84,34,0.15)]">
                            Admissions 2026
                        </span>
                    </motion.div>
                    ...
                    >
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-[#FF5422] drop-shadow-sm">
                            of Engineers
                        </span>
                    </motion.h2>
                    ...
                    >
                        <motion.a
                            ...
                            className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-orange-500 to-[#FF5422] text-white text-xs md:text-sm font-bold tracking-widest uppercase rounded-full flex items-center justify-center gap-3 transition-all duration-300 group shadow-lg"
                        >
                            Apply Now
