        ...
        <>
            {isCSE ? (
                ...
                <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-[1fr_1fr] gap-8 lg:gap-12">
                        
                        {/* Left Column: Image */}
                        <div className="space-y-6">
                            <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold uppercase text-neutral-dark flex flex-wrap items-center gap-3 sm:gap-4 tracking-tight">
                                <span className="w-10 h-[3px] bg-primary rounded-full"></span>
                                ABOUT THE DEPARTMENT
                            </h2>
                            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden shadow-md max-w-2xl">
                        ...
                        <div className="space-y-8 xl:pt-16">
                            ...
                            <div className="space-y-5">
                                <h3 className="font-serif text-xl sm:text-2xl font-bold text-neutral-dark">{dept.name}</h3>
                                <div className="text-neutral-600 text-[14.5px] leading-[1.8] text-justify space-y-4">
                                ...
                                <div className="pt-2">
                                    <a
                                        href="https://www.srit.ac.in/computer-science-engineering/"
                                        target="_blank"
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div className="space-y-6 flex flex-col h-full">
                            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-neutral-100 flex-1">
                                <h3 className="text-[#FF5422] font-black text-sm lg:text-[14px] uppercase tracking-[0.2em] mb-3">Vision</h3>
                                <p className="text-neutral-600 text-[14px] lg:text-[15px] leading-[1.7] text-justify">
                                    {dept.vision}
                                </p>
                            </div>
                            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-neutral-100 flex-1">
                                <h3 className="text-[#FF5422] font-black text-sm lg:text-[14px] uppercase tracking-[0.2em] mb-3">Mission</h3>
                                <div className="text-neutral-600 text-[14px] lg:text-[15px] leading-[1.7] space-y-2 text-justify">
                                    {dept.mission.map((m) => (
                                        <p key={m.id}>{m.text}</p>
                                    ))}
                                </div>
                        ...
                        <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-neutral-100 h-full">
                            <h3 className="font-serif text-xl font-bold flex items-center gap-3 mb-6 text-neutral-dark">
                            ...
                            <div className="space-y-4 lg:space-y-5">
                                {dept.highlights.map((highlight, idx) => (
                                    <div key={idx} className="flex items-start gap-3">
                                        ...
                                        <p className="text-neutral-600 text-[14px] font-medium leading-[1.7]">
                                            {highlight}
                                        </p>
                                    </div>
                                ))}
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_1fr] gap-6 lg:gap-8">
                        ...
                        <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-neutral-100 flex flex-col sm:flex-row gap-8 items-center sm:items-start h-full">
                            ...
                            <div className="flex-1 text-left pt-2">
                                <h3 className="font-serif text-2xl font-bold text-neutral-dark">{dept.hodMessage.name}</h3>
                                <p className="text-primary text-xs font-bold uppercase tracking-[0.2em] mt-2 mb-4">
                                    {dept.hodMessage.designation}
                                </p>
                                <p className="text-neutral-600 italic text-[14px] lg:text-[15px] leading-[1.7] mb-5 font-serif text-left">
                        ...
                        <div className="bg-primary text-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl shadow-primary/20 flex flex-col h-full justify-between">
                            <div>
                                <h3 className="font-serif text-xl font-bold flex items-center gap-3 mb-8">
