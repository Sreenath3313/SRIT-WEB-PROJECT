    ...
    return (
        <div className="min-h-screen bg-neutral-50 flex flex-col font-sans">
            ...
            <div className="relative pt-[122px] pb-14 lg:pt-[140px] lg:pb-18 bg-[#0A0903] overflow-hidden">
                ...
                <motion.div
                    className="absolute top-0 right-0 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] rounded-full bg-[#FF5422]/20 blur-[80px] sm:blur-[100px] lg:blur-[140px]"
                    animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.5, 0.3] }}
                    transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
                    style={{ translateX: '30%', translateY: '-30%' }}
                />
                <motion.div
                    className="absolute bottom-0 left-0 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] rounded-full bg-[#FF5422]/15 blur-[60px] sm:blur-[80px] lg:blur-[120px]"
                ...
                <div className="max-w-[1100px] mx-auto px-4 sm:px-5 md:px-6 relative z-10 text-center">
                    {/* Breadcrumb */}
                    <motion.div
