...
const OrganizationChartPage: React.FC = () => {
    return (
        <AboutUsLayout title="Organization Chart">
            <h3 className="text-2xl font-serif font-bold text-[#0A0903] mt-8 mb-4">Organization Chart</h3>
<p className="text-neutral-600 leading-relaxed mb-4">SRIT’s contribution to the world of academia, especially technical academia has been recognised by the nation’s finest empowering authorities. SRIT has been accredited by:</p>
<img src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201231%20663'%3E%3C/svg%3E" alt="Image" className="max-w-full h-auto rounded-lg my-6" />
<img src="https://www.srit.ac.in/wp-content/uploads/2021/07/OC-img.jpg" alt="Image" className="max-w-full h-auto rounded-lg my-6" />
