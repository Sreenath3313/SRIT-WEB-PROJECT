            ...
            <div className="section-container pb-16">
                <div className="flex flex-col gap-4 w-full">
                    {accordionData.map((item, index) => {
                        ...
                        return (
                            <div key={index} className="w-full rounded-xl overflow-hidden transition-all duration-300" style={{ border: isOpen ? '1px solid rgba(255, 84, 34, 0.25)' : '1px solid rgba(10, 9, 3, 0.06)', boxShadow: isOpen ? '0 4px 20px rgba(255, 84, 34, 0.12)' : '0 1px 4px rgba(0,0,0,0.06)' }}>
                                <button
